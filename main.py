...
# CORS — the Streamlit dashboard runs on a different port
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# Core routes (analyze, generate, tracker, quota, analytics, etc.)
app.include_router(
    api_router,
...
# New feature routes (score-breakdown, market-insights, versions, feedback...)
app.include_router(
    new_features_router,
    prefix="/api/v1/resume",
    tags=["New Features"],
